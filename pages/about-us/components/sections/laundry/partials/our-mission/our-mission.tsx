	...
	return (
		<Box position={'relative'} bgcolor={'background.default'} height={1} p={2} pt={8} borderRadius={2} border={'3px solid white'} boxShadow={'0px 0px 7px 0px rgba(0, 0, 0, 0.15)'}>
			...
			<Stack alignItems={'center'} height={1}>
				...
				<Box position={'relative'} width={1} maxWidth={3318 * 0.125} mb={-2} mt={2} mx={'auto'} sx={{ aspectRatio: '1/1' }}>
					<Image src={'/images/figure_4.png'} alt="Vision Figure" style={{ objectFit: 'cover', objectPosition: 'top' }} fill />
				</Box>
			</Stack>
		</Box>
	);
