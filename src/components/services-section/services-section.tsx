		...
		<Box component={'section'} width={1} py={5} overflow={'hidden'} bgcolor={'background.paper'}>
			...
			<Stack direction={'row'} justifyContent={'center'} alignItems={'center'} spacing={4} mt={4} useFlexGap>
				...
				<Stack spacing={2} display={{ xs: 'none', md: 'flex' }} useFlexGap>
					...
					<Stack direction={'row'} justifyContent={'flex-start'} alignItems={'flex-start'} flexWrap={'wrap'} spacing={2} useFlexGap>
					...
					<Button variant="contained" color="secondary" size="large" endIcon={<ArrowForward />} sx={{ alignSelf: 'flex-start' }}>
